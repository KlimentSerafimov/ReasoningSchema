...
class BitvectorTasks {
    ...
    void augment_subdomains(vector<MaskAndCostAndInstantiatedModules*>& subdomains, BittreeTaskType* current_bittree, int num_prev_subtasks, int task_id);

    vector<MaskAndCostAndInstantiatedModules*> get_next_subdomains(
    ...
    void delta_wiring(vector<MaskAndCostAndInstantiatedModules*> &subdomains, BittreeTaskType *task_type, int task_id,
